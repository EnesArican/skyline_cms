			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						...
						<form:select path="" required="true" class="form-control" id="selected-accomodation">
							<option	style="display: none" disabled selected value=>--</option>                            	
							...
							<c:forEach var="tempProperty" items="${properties}">					
								<form:option value="${tempProperty.id}">SKY-
													...
													<c:if test="${tempProperty.skyCode < 10}">0</c:if>
																${tempProperty.skyCode}:      ${tempProperty.address} </form:option>										
							</c:forEach>												
						</form:select>
			...
			<div class="row">
				...
				<div class="col-md-3">                                       	
					<div class="form-group">
						...
						<form:input id="start-date" path="" required="true" class="form-control" disabled="true" /> 
						<form:errors path="" cssClass="serverSideError" />                                  
					</div>                                      
				</div> 
				<div class="col-md-3">                                       	
					<div class="form-group">
						...
						<form:input id="end-date" path="" required="true" class="form-control" disabled="true" /> 
						<form:errors path="" cssClass="serverSideError" /> 					         
					</div>	                                       
				</div> 		
				<div class="col-md-2">  
