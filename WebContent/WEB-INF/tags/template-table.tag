...
<tmp:template-general>
	...
	<div id="page-wrapper">
            <div class="row">
                ...
                <div class="col-lg-3 inner" id="editButtons">    
                    			<a href="formAddProperty" class="btn btn-primary">Add</a>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" cellspacing="0" id="house-profiles-table">
                                <thead>
                                    <tr>
  				...
  				<div class="modal-dialog">
   					...
   					<div class="modal-content">
    						...
    						<div class="modal-body">
    							<p>Are you sure you want to delete the highlighted property?</p>
    						</div>
	...
	<jsp:attribute name="footer">
    	...
    	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/house_profiles.js"></script>
    </jsp:attribute>
